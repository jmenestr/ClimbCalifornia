(function(root){
  var SELECTED_USER_CHANGE = "SELECTED_USER_CHANGE";
  ...
  var _updateCurrentUser = function(user) {
    ...
    UserStore.emit(SELECTED_USER_CHANGE)
  };
  ...
  root.UserStore = _.extend({}, EventEmitter.prototype, {
    ...
    addCurrentChangeEventListener: function(callback) {
      this.addListener(SELECTED_USER_CHANGE, callback);
    },

    removeCurrentChangeEventListener: function(callback) {
      this.removeListener(SELECTED_USER_CHANGE, callback)
    },
